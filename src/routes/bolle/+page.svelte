...
<div class="bg-white">
	...
	<div class="mt-4">
		<div class="hidden lg:flex -mx-4 overflow-x-auto sm:mx-0">
						...
						{#each pages as page}
							{#if selected != page.selector}
								<li class="select-none p-4 text-sm hover:bg-tvbluelight hover:text-white">
									...
									>
										<p class="font-medium text-sm mx-4">{page.name}</p>
									</button>
								</li>
							{/if}
						{/each}
